...
<div class="bg-gradient-to-br from-emerald-50 via-teal-50 to-green-50 min-h-screen">
    <div class="flex-1">
            ...
            <div class="container px-4 md:px-6 relative z-10">
                <div class="grid items-center gap-8 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_550px]">
                    <div class="space-y-6">
                        <div class="space-y-4">
                            ...
                            <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl xl:text-6xl">
                                Seamless <span class="text-transparent bg-clip-text bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600">Cloud</span><br>
                                <span class="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 via-green-600 to-emerald-600">Migration</span>
                            </h1>
                            
                            <p class="max-w-2xl text-gray-700 text-lg md:text-xl leading-relaxed">
                                Transform your business with our expert Cloud Migration Services. We ensure minimal disruption, enhanced security, and ongoing support for a smooth transition to the cloud.
                            </p>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h2 class="text-lg font-semibold text-gray-900 mb-1">Business Continuity</h2>
                                    <p class="text-gray-600">Maintain operations during and after migration with zero downtime strategies.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h2 class="text-lg font-semibold text-gray-900 mb-1">Enhanced Security</h2>
                                    <p class="text-gray-600">Advanced security measures protect your data throughout the migration process.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h2 class="text-lg font-semibold text-gray-900 mb-1">Scalable Solutions</h2>
                                    <p class="text-gray-600">Cloud infrastructure that grows with your business needs and adapts to change.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <img
                            src="../services/cloud-migration.svg"
                            width="550"
                            height="310"
                            alt="Cloud Migration"
            ...
            <div class="container px-4 md:px-6">
                ...
                <div class="text-center space-y-4 mb-16">
                    ...
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900">
                        Comprehensive <span class="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">Cloud Migration</span> Solutions
                    </h2>
                    <p class="max-w-3xl mx-auto text-gray-600 text-lg">
                        Our expert team provides a complete range of services to ensure a smooth, secure, and efficient migration to the cloud.
                    </p>
                </div>
                ...
                <div class="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
                    <div class="relative order-2 lg:order-1">
                        ...
                        <div class="relative bg-white rounded-3xl p-8 shadow-2xl border border-green-100/50">
                            <img
                                src="../services/cloud-migration-secondary.svg"
                    ...
                    <div class="space-y-8 order-1 lg:order-2">
                        ...
                        <div class="group relative bg-gradient-to-br from-white to-green-50/30 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-green-100/50">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-green-700 transition-colors">Migration Planning & Strategy</h3>
                                    <p class="text-gray-600 leading-relaxed">
                                        We work closely with you to develop a customized migration plan that aligns with your business requirements and minimizes disruption.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="group relative bg-gradient-to-br from-white to-emerald-50/30 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-emerald-100/50">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-emerald-700 transition-colors">Secure Data Migration</h3>
                                    <p class="text-gray-600 leading-relaxed">
                                        Safe and efficient transfer of your data to the cloud with robust security measures and minimal business disruption.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="group relative bg-gradient-to-br from-white to-teal-50/30 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-teal-100/50">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-teal-700 transition-colors">Ongoing Support</h3>
                                    <p class="text-gray-600 leading-relaxed">
                                        Comprehensive post-migration support to ensure your cloud environment runs smoothly and efficiently long after the migration.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="group relative bg-gradient-to-br from-white to-green-50/30 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-green-100/50">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-green-700 transition-colors">Enterprise Security</h3>
                                    <p class="text-gray-600 leading-relaxed">
                                        Advanced security protocols and measures to protect your data throughout the entire migration process and beyond.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <ServiceCta service="cloud migration" />
    </div>
</div>
